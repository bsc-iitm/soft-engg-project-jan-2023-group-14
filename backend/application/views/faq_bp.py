...
class FAQUtils(UserUtils):
    ...
    def save_faq_attachments(
        self, attachments: list, faq_id: str, operation: str
    ):
            ...
            if attach["attachment_loc"]: 
                if is_base64(attach["attachment_loc"].split(",")[1]):
                    ...
                    if (file_type == "image") and (
                        ...
                        file_name = (
                            f"{faq_id}_{number_extension}.{file_format}"
                        )
...
class FAQAPI(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            logger.error(
                f"FAQAPI->get : Error occured while fetching FAQ data : {e}"
            )
    ...
    def post(self):
        ...
        # except Exception as e:
        #     logger.error(
        #         f"FAQAPI->post : Error occured while getting form data : {e}"
        #     )
        #     raise InternalServerError
        # get form Data
        details = {
