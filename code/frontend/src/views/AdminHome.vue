    ...
    <div>
      ...
      <b-row class="text-start">
        <b-col cols="12" sm="5" md="4">
          <InfoCard title="New User Registered" :value="new_registered_users().toString()"></InfoCard>
          <InfoCard title="Total Open Tickets" :value="n_total_unresolved_tickets.toString()"></InfoCard>
          <InfoCard title="Total Resolved Tickets" :value="n_total_resolved_tickets.toString()"></InfoCard>
        </b-col>
        <b-col cols="12" sm="5" md="4" >
          <InfoCard title="New Tickets Raised Today" :value="n_tickets_today.toString()"></InfoCard>
          <InfoCard title="New Tickets Raised This Week" :value="n_tickets_week.toString()"></InfoCard>
          <InfoCard title="New Tickets Raised This Month" :value="n_tickets_month.toString()"></InfoCard>
        </b-col>
        <b-col cols="12" sm="5" md="4" >
