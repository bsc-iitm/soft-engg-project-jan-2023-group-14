      ...
      <b-row class="text-start">
        <b-col cols="12" sm="6" md="6">
          ...
          <div style="height: 550px; overflow: auto; padding: 10px">
            <div v-for="user in unverified_new_user" :key="user.user_id" v-if="user.role == 'student'">
              <UserCard
        ...
        <b-col cols="12" sm="6" md="6" style="border-left: dashed black">
          ...
          <div style="height: 550px; overflow: auto; padding: 10px">
            <div v-for="user in unverified_new_user" :key="user.user_id" v-if="user.role == 'support'">
              <UserCard
                :n_user_id= "user.user_id"
                :first_name= "user.first_name"
                :last_name= "user.last_name"
