...
class Ticket(db.Model):
    ...
    priority = db.Column(db.String, nullable=False, default="low") # low (default), medium, high
    ...
    votes = db.Column(db.Integer, nullable=False, default=0)  # creater can't vote, 1 vote/student
...
class TicketAttachment(db.Model):
    ...
    ticket_id = db.Column(db.String, db.ForeignKey("ticket.ticket_id"), primary_key=True)
